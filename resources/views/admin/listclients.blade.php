                    ...
                    @if($elem->role_as==3)
                        <tr>
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <div>
                                        ...
                                        <img src="{{asset('uploads/users/'.$elem->image)}}"
                            ...
                            <td class="align-middle text-center text-sm">
                                <span class="badge badge-sm bg-gradient-success"><p
                                        class="text-xs font-weight-bold mb-0">@if($elem->role_as==1)Admin @else
                                            client @endif</p></span>
                            </td>

                            <td class="align-middle">
                                <a href="{{ route('admin.edit', $elem->id) }}#"
